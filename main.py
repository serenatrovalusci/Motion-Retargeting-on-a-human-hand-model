...
def parse_args():
    ...
    parser.add_argument('--no_pca', action='store_true', help='Do not apply PCA to the target dataset')
    parser.add_argument('--pca_components', type=int, default=16, help='Number of PCA components to keep')
...
if __name__ == "__main__":
    ...
    print("1) --use_pca --pca_components n.components --weights_path weights_path --scaler_path scaler_path --pca_path pca_path")
    print("2) --no_pca --weights_path weights_path --scaler_path scaler_path")  
